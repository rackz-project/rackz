> **Deprecated for Rackz use.** This is a generic CryptoNote 1.x forking guide.
> File paths, struct names, and CMake targets it references **do not match this
> codebase**. See [`docs/rackz/RACKZ_CONFIG.md`](RACKZ_CONFIG.md) for the
> accurate, Monero-derived fork configuration reference.
